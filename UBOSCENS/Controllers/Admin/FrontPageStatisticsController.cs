...
namespace UBOSCENS.Controllers.Admin
{
    public class FrontPageStatisticsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,SectionID,Title")] FrontPageStatistics frontPageStatistics, IEnumerable<HttpPostedFileBase> file)
        {
            var data = "";
